package com.transmit.datatransfer;
...
public class CodeGenerater {
    ...
    public static void main(String[] args) {
        ...
        gc.setServiceName("I%sService");    // 服务名称
        gc.setServiceImplName("%sServiceImpl"); // 服务接口名称
        mpg.setGlobalConfig(gc);

        // 数据源配置
        DataSourceConfig dsc = new DataSourceConfig();
        dsc.setUrl("jdbc:mysql://192.168.120.55:13306/data_analy_zs?useSSL=false&zeroDateTimeBehavior=convertToNull&useLegacyDatetimeCode=false");
        dsc.setSchemaName("data_analy_zs");
        ...
        pc.setModuleName("datatransfer");   //模块名
        pc.setParent("com.transmit"); //包名
        pc.setEntity("domain");   //数据库对应的包名
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义xml输出文件名
                return projectPath + "/src/main/resources/mapper/portrait"
